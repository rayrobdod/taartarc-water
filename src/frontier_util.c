...
{
    [FRONTIER_FACILITY_TOWER]   = {OBJ_EVENT_GFX_SEEL_DOLL, TRUE},
    [FRONTIER_FACILITY_DOME]    = {OBJ_EVENT_GFX_SEEL_DOLL, FALSE},
    [FRONTIER_FACILITY_PALACE]  = {OBJ_EVENT_GFX_SEEL_DOLL, FALSE},
    [FRONTIER_FACILITY_ARENA]   = {OBJ_EVENT_GFX_SEEL_DOLL, TRUE},
    [FRONTIER_FACILITY_FACTORY] = {OBJ_EVENT_GFX_SEEL_DOLL, FALSE},
    [FRONTIER_FACILITY_PIKE]    = {OBJ_EVENT_GFX_SEEL_DOLL, TRUE},
    [FRONTIER_FACILITY_PYRAMID] = {OBJ_EVENT_GFX_SEEL_DOLL, FALSE},
};
