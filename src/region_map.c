...
static const u32 sRegionMapBg_GfxLZ[0xd64 / 4] = INCBIN_U32("graphics/pokenav/region_map/map.8bpp.lz");
static const u32 sRegionMapBg_TilemapLZ[0x34c / 4] = INCBIN_U32("graphics/pokenav/region_map/map.bin.lz");
static const u16 sRegionMapPlayerIcon_LancePal[] = INCBIN_U16("graphics/pokenav/region_map/lance_icon.gbapal");
static const u8 sRegionMapPlayerIcon_LanceGfx[] = INCBIN_U8("graphics/pokenav/region_map/lance_icon.4bpp");
...
{
    [MAPSEC_LITTLEROOT_TOWN] = {MAP_GROUP(LITTLEROOT_TOWN), MAP_NUM(LITTLEROOT_TOWN), HEAL_LOCATION_STORAGE_ROOM},
...
{
    u8 spriteId;
    struct SpriteSheet sheet = {sRegionMapPlayerIcon_LanceGfx, 0x80, tileTag};
    struct SpritePalette palette = {sRegionMapPlayerIcon_LancePal, paletteTag};
