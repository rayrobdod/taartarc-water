...
const u32 gObjectEventPic_LotadSwimming[] = INCBIN_U32("graphics/pokemon/lotad/overworld_submerged.4bpp");
...
const u16 gObjectEventPal_Lotad[] = INCBIN_U16("graphics/pokemon/lotad/overworld_normal.gbapal");
