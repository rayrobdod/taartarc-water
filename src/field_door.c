...
static const u8 sDoorAnimTiles_AquariumLeft[] = INCBIN_U8("graphics/door_anims/aquarium_left.4bpp");
__attribute__((section("added_rodata")))
static const u8 sDoorAnimTiles_AquariumRight[] = INCBIN_U8("graphics/door_anims/aquarium_right.4bpp");
...
__attribute__((section("added_rodata")))
static const u8 sDoorAnimPalettes_Aquarium[] = {3, 3, 3, 3, 3, 3, 3, 3};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Gardens_Door_Left,                            DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_AquariumLeft, sDoorAnimPalettes_Aquarium},
    {METATILE_Gardens_Door_Right,                           DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_AquariumRight, sDoorAnimPalettes_Aquarium},
    {},
};
