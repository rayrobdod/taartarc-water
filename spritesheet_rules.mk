...
$(OBJEVENTGFXDIR)/people/lance/walking.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4

$(OBJEVENTGFXDIR)/people/lance/running.4bpp: %.4bpp: %.png
	$(GFX) $< $@ -mwidth 2 -mheight 4
...
graphics/title_screen/cerulean_aquarium.8bpp: %.8bpp: %.png
